...
public class ClienteService {
	...
	public Cliente findByEmail(String email) {
		...
		Optional<Cliente> obj = repo.findByEmail(user.getUsername());
		
		return obj.orElseThrow(() -> new ObjectNotFoundException(
				"Objeto não encontrado! Id: " + obj.get().getEmail() + ", Tipo: " + Cliente.class.getName()));
	}
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		...
		Endereco end = new Endereco(null, 
				objDto.getLogradouro(), objDto.getNumero(), objDto.getComplemento(), objDto.getBairro(), 
				objDto.getCep(), 
				cli, cid);
